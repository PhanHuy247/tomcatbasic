...
<html>
    ...
    <body>
        ...
        <% SendAPI send = new SendAPI();
            ...
            String URL = constant.Constant.LOCAL_JPNS;
        ...
        <div style="position: relative;z-index: 99">
            <nav>
                <a href="index.jsp" class="icon-home">Main</a>
                ...
                <div class="animation start-jpns"></div>
                                    ...
                                    <form id="form${country.key}" action="SendAndReadAPI" method="POST" class="w3-container" onsubmit="myFunction('${country.key}')">
                                        <tr class="row100">
                                            ...
                                            <td class="column100 column3" data-column="column3">
                                                ...
                                                <input  type="hidden" name="app" value="jpns">  
                                                <input disabled="true" id="button${country.key}" class="w3-btn w3-blue-grey" type="submit" value="Update" name="update" /> 
                                            </td>
                                        </tr>
                                    </form>
                                </c:if>
